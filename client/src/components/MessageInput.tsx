...
interface MessageInputProps {
  ...
  handleMsgSend: (e: any, imageFile?: File | null) => Promise<void>;
}
...
const MessageInput = ({
  ...
  const handleSubmit = async (e: any) => {
    ...
    setIsUploading(true);
    await handleMsgSend(e, imageFile);
    setImageFile(null);
      ...
      {imageFile && (
        <div className="relative w-fit">
          <img
            ...
            alt="image-preview"
            className="w-24 h-24 object-cover rounded-lg border border-t-gray-600"
          />
          <button
            type="button"
